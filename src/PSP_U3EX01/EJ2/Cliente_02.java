...
public class Cliente_02 {
    public static void main(String[] args) throws IOException {
        ...
        PSP_U3EX01.Cliente cli = new PSP_U3EX01.Cliente(); //Se crea el cliente
        cli.startClient();
        System.out.println("Que pregunta quiere hacer \n 1. Com et dius? \n 2. Quantes lineas de codi tens? \n 3. Otra");

        switch (sc.nextInt()) {
            case 1 -> cli.sendToServer("Com et dius?");
            case 2 -> cli.sendToServer("Quantes lineas de codi tens?");
            case 3 -> cli.sendToServer("Otra");
        }
